...
const GREETINGS: Record<string, string> = {
  "/projects":
    "Which project do you want to dig into — Nolan AI, Finverse, or SignSync?",
  "/experience":
    "Ask me anything about my work at Hooman Labs or IIT Patna.",
  "/hackathons": "Two firsts, one runner-up — what do you want to know?",
  "/skills":
    "Ask about any specific tech or how I've applied it in production.",
        ...
        const apiMessages = contextSeed
          ? [
              { role: "user" as const, content: contextSeed },
              {
                ...
                content:
                  "Understood. I'll focus my answers on this page's context.",
              },
              ...visibleHistory,
            ]
          : visibleHistory;
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 11, color: "#505058" }}>
